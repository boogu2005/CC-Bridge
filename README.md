...
## 1. 项目概述
![CC-Bridge claudebot微信聊天](./assets/wechatclaudebot.png)
本项目所实现的微信 Claudebot，区别于市面绝大多数同类微信机器人项目：
主流同类项目大多直接调用原生 Claude CLI 客户端完成交互与逻辑处理，而本项目不依赖原生 Claude CLI 直连模式。
